...
public class MomoFrame extends JFrame {
	...
	public MomoFrame() {
		...
		JLabel lblNewLabel = new JLabel("Momo");
		...
		JLabel lblNewLabel_1 = new JLabel(new ImageIcon((Toolkit.getDefaultToolkit()
				.createImage(Frame.class.getResource("..\\Image\\momo.png")))));
		lblNewLabel_1.setBounds(33, 76, 671, 599);
		contentPane.add(lblNewLabel_1);
		
		btnConfirm = new JButton("Confirm");
		btnConfirm.setActionCommand("Confirm_momo");
